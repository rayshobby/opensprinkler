...
// Aug 2013, jonathanmarsh.net : generalized options
...
for(oid=0;oid<opts.length;oid++){
  ...
  if(datatype == "boolean") {
    ...
    case "htp":
      ...
      w("<p title=\""+tooltip+"\"><b>"+label+":</b> <input type=text size=5 maxlength=5 value="+value+" name=ohtp>");
      break;
    case "nbrd":
  ...
  //w("</p>");
  w(" <span style=\"background-color:#FFF2B8;\" id=tip"+oid+" hidden=\"hidden\"><font size=2>"+tooltip+"</font></span></p>");
}
