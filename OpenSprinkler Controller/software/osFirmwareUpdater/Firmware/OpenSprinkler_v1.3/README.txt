...
*********************************
*********************************
This firmware is for hardware 1.3
*********************************
*********************************

-------- This folder contains compiled .hex binary files for OpenSprinkler v1.3u --------

OpenSprinkler v1.3u has on-board USB TinyISP programmer. Basic instructions are as follows:
