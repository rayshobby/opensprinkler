...
ib("\"fcancel()\"","back","Back");
ib("\"mod(mf,-1)\"","addall","<b>Add a New Program</b>");
ib("\"del(df,-1)\"","delall","Delete All");
ib("\"fplot()\"","preview","Preview");
w("<hr><b>Total number of programs: "+nprogs+" (maximum is "+mnp+")</b><br>");
// print programs
