...
*********************************
*********************************
This firmware is for hardware 1.4
*********************************
*********************************

-------- This folder contains compiled .hex binary files for OpenSprinkler v1.4 --------

OpenSprinkler v1.4(u or s) has on-board USB TinyISP programmer. Basic instructions are as follows:
