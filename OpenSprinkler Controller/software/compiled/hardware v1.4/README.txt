...
-------- This folder contains compilex .hex files for OpenSprinkler v1.4 --------

OpenSprinkler v1.4(u or s) has on-board USBtiny programmer. Basic instructions are as follows:
