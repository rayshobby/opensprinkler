...
This firmware (2.0.1) uses the microSD card available on OpenSprinkler 2.0 to store and serve Javascripts required for rendering OpenSprinkler webpages. To use this firmware, please read the instructions below:
